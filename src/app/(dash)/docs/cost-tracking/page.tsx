  ...
  return (
    <div className="max-w-3xl mx-auto py-4">
      ...
      <div className="space-y-6 text-sm text-zinc-700">
        ...
        <section>
          <h2 className="text-lg font-semibold text-zinc-900 mb-2">O que é</h2>
          <p>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1">
            ...
            <li>
              ...
              o sistema abre um incidente automático do tipo <code className="bg-zinc-100 px-1 rounded text-xs">cost-spike</code>.
            </li>
          ...
          <p className="mt-2">
            ...
            <strong className="text-zinc-900">&ldquo;— não configurado&rdquo;</strong> no lugar do valor monetário.
            Isso é intencional — preferimos mostrar que não há dado a exibir um &ldquo;$0,00&rdquo; enganoso.
          </p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-zinc-900 mb-2">Como funciona tecnicamente</h2>
          <ol className="list-decimal list-inside space-y-1">
            <li><strong>Coletor agendado (cron):</strong> toda noite, aproximadamente às 6h UTC, o Nexus executa <code className="bg-zinc-100 px-1 rounded text-xs">runCost</code> para cada Connection ativa.</li>
            <li>
              <strong>Chamada à Cloud Monitoring API:</strong> o coletor pergunta à API do Google:{' '}
              <em>&ldquo;qual foi o valor da métrica <code className="bg-zinc-100 px-1 rounded text-xs">billing.googleapis.com/billing/total_cost</code> para este projeto Firebase ontem?&rdquo;</em>
            </li>
            <li><strong>Gravação no banco:</strong> o valor retornado é salvo em <code className="bg-zinc-100 px-1 rounded text-xs">CostSnapshot</code> com a data correspondente.</li>
        ...
        <section>
          <h2 className="text-lg font-semibold text-zinc-900 mb-2">Por que mostra &ldquo;Não configurado&rdquo;</h2>
          <p>
            A métrica <code className="bg-zinc-100 px-1 rounded text-xs">billing.googleapis.com/billing/total_cost</code> só
          ...
          <ul className="list-disc list-inside mt-1 space-y-1">
            ...
            <li>O <code className="bg-zinc-100 px-1 rounded text-xs">runCost</code> não salva nenhum snapshot.</li>
        ...
        <section>
          <h2 className="text-lg font-semibold text-zinc-900 mb-2">Quanto custa para a empresa</h2>
          <p className="font-semibold text-zinc-900">Custo real: R$ 0,00.</p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-zinc-900 mb-2">Como habilitar</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-zinc-900 mb-2">Permissão necessária</h2>
          <p>
            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="bg-zinc-50">
                  <th className="border border-zinc-200 px-3 py-2 text-left font-medium text-zinc-700">Papel</th>
                  <th className="border border-zinc-200 px-3 py-2 text-left font-medium text-zinc-700">Onde fica</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="border border-zinc-200 px-3 py-2 font-mono text-xs">roles/billing.admin</td>
                  <td className="border border-zinc-200 px-3 py-2">Conta de billing</td>
                </tr>
                <tr className="bg-zinc-50">
                  <td className="border border-zinc-200 px-3 py-2 font-mono text-xs">roles/billing.costsManager</td>
                  <td className="border border-zinc-200 px-3 py-2">Conta de billing</td>
                </tr>
              </tbody>
            </table>
          ...
          <p className="mt-2">
            O service account já configurado no Nexus possui <code className="bg-zinc-100 px-1 rounded text-xs">Monitoring Viewer</code>,
        ...
        <section>
          <h2 className="text-lg font-semibold text-zinc-900 mb-2">Alternativas se o export não for possível agora</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-zinc-900 mb-2">Quando vai funcionar automaticamente</h2>
          <p>Assim que:</p>
          <ol className="list-decimal list-inside mt-1 space-y-1">
            ...
            <li>O service account do Nexus tiver <code className="bg-zinc-100 px-1 rounded text-xs">Monitoring Viewer</code> no projeto Firebase (já está configurado),</li>
          </ol>
          <p className="mt-2">
